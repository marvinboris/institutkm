...
class Add extends Component {
    ...
    componentDidUpdate(prevProps) { utility.add.lifecycle.componentDidUpdate('training_levels', 'training_level')(prevProps, this.props, this.state, this.setState.bind(this), this.resetState) }
    componentWillUnmount() { this.props.reset() }
    render() {
        const {
            content: {
                cms: {
                    pages: { backend: { pages: { training_levels: { form } } } }
                }, languages
            },
        } = this.props;
        const { name, translate } = this.state;
        ...
        return <utility.add.lifecycle.render className='TrainingLevels' props={this.props} state={this.state} resource={'training_levels'}>
            {content}
