    ...
    value: function render() {
      ...
      var data = testimonies.map(function (testimony) {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(testimony, {
          ...
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_3__["default"], {
            photo: testimony.photo,
            see: see,
            title: "".concat(form.testimony_photo, ": ").concat(testimony.name)
          }),
