"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_TrainingCategories_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/TrainingCategories/index.js":
/*!*********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/TrainingCategories/index.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/training-categories */ "./resources/js/src/store/actions/backend/training-categories.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.pages.training_categories.form,
          _this$props$backend$t = _this$props.backend.training_categories.training_categories,
          training_categories = _this$props$backend$t === void 0 ? [] : _this$props$backend$t;
      var lang = localStorage.getItem('backend_lang');
      var data = training_categories.map(function (training_category) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(training_category, {
          ...
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_2__["default"], {
            photo: training_category.photo,
            see: see,
            title: "".concat(form.category_photo, ": ").concat(training_category.name[lang])
          }),
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(training_category.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
