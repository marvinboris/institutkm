...
/* harmony import */ var _store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../store/actions/backend/publication-categories */ "./resources/js/src/store/actions/backend/publication-categories.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.pages.publication_categories.form,
      ...
      var data = publication_categories.map(function (publication_category) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.updateObject)(publication_category, {
          name: publication_category.name[lang],
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.convertDate)(publication_category.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_3__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_publication_categories__WEBPACK_IMPORTED_MODULE_3__["default"].reset());
    }
  };
};
