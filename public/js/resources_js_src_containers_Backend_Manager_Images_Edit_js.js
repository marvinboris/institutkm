"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Images_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Images/Add.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Images/Add.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_images__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/images */ "./resources/js/src/store/actions/backend/images.js");
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add() {
    ...
    _defineProperty(_assertThisInitialized(_this), "fileUpload", function (id) {
      return _utility__WEBPACK_IMPORTED_MODULE_5__.add.component.fileUpload(id);
    });
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      _utility__WEBPACK_IMPORTED_MODULE_5__.add.lifecycle.componentDidUpdate('images', 'image')(prevProps, this.props, this.state, this.setState.bind(this), this.resetState);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          form = _this$props.content.cms.pages.backend.pages.images.form,
          _this$props$backend$i = _this$props.backend.images.image,
          image = _this$props$backend$i === void 0 ? {} : _this$props$backend$i;
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_utility__WEBPACK_IMPORTED_MODULE_5__.add.lifecycle.render, {
        className: "Images",
        props: this.props,
        state: this.state,
        resource: 'images',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_images__WEBPACK_IMPORTED_MODULE_4__["default"].show(id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_images__WEBPACK_IMPORTED_MODULE_4__["default"].post(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_images__WEBPACK_IMPORTED_MODULE_4__["default"].patch(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_images__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Manager/Images/Edit.js":
/*!********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Images/Edit.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/Manager/Images/Add.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
/***/ "./resources/js/src/store/actions/backend/images.js":
/*!**********************************************************!*\
  !*** ./resources/js/src/store/actions/backend/images.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['images', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.IMAGES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.IMAGES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.IMAGES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  reset: function reset() {
    return {
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.IMAGES_RESET
    };
  },
