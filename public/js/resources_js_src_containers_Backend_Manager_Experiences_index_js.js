...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../../store/actions/backend/experiences'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(page, show, search));
    },
