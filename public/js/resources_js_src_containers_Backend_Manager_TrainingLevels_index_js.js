"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_TrainingLevels_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/TrainingLevels/index.js":
/*!*****************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/TrainingLevels/index.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_training_levels__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../store/actions/backend/training-levels */ "./resources/js/src/store/actions/backend/training-levels.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.pages.training_levels.form,
          _this$props$backend$t = _this$props.backend.training_levels.training_levels,
          training_levels = _this$props$backend$t === void 0 ? [] : _this$props$backend$t;
      var lang = localStorage.getItem('backend_lang');
      var data = training_levels.map(function (training_level) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.updateObject)(training_level, {
          name: training_level.name[lang],
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.convertDate)(training_level.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_training_levels__WEBPACK_IMPORTED_MODULE_3__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_training_levels__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_training_levels__WEBPACK_IMPORTED_MODULE_3__["default"].reset());
    }
  };
};
