"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_TrainingCategories_Edit_js"],{
  ...
  _createClass(Breadcrumb, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_6__["default"], {
        className: "UI Breadcrumb d-none d-sm-flex",
...
/***/ "./resources/js/src/containers/Backend/Manager/TrainingCategories/Add.js":
/*!*******************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/TrainingCategories/Add.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../store/actions/backend/training-categories */ "./resources/js/src/store/actions/backend/training-categories.js");
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      _utility__WEBPACK_IMPORTED_MODULE_6__.add.lifecycle.componentDidUpdate('training_categories', 'training_category')(prevProps, this.props, this.state, this.setState.bind(this), this.resetState);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content.cms.pages.backend.pages.training_categories.form,
          languages = _this$props$content.languages,
          _this$props$backend$t = _this$props.backend.training_categories,
          _this$props$backend$t2 = _this$props$backend$t.subjects,
          subjects = _this$props$backend$t2 === void 0 ? [] : _this$props$backend$t2,
          _this$props$backend$t3 = _this$props$backend$t.training_category,
          training_category = _this$props$backend$t3 === void 0 ? {} : _this$props$backend$t3;
      var _this$state = this.state,
          subject_id = _this$state.subject_id,
          photo = _this$state.photo;
      var lang = localStorage.getItem('backend_lang');
      var subjectsOptions = subjects.map(function (subject) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.updateObject)(subject, {
        ...
        children: [this.props.edit && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("input", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_UI_Input__WEBPACK_IMPORTED_MODULE_3__["default"], {
              ...
              cms: form,
              defaultValue: training_category.photo,
              value: photo
            })
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_utility__WEBPACK_IMPORTED_MODULE_6__.add.lifecycle.render, {
        className: "TrainingCategories",
        props: this.props,
        state: this.state,
        resource: 'training_categories',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__["default"].show(id));
    },
    info: function info() {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__["default"].info());
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__["default"].post(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__["default"].patch(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_training_categories__WEBPACK_IMPORTED_MODULE_5__["default"].reset());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Manager/TrainingCategories/Edit.js":
/*!********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/TrainingCategories/Edit.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/Manager/TrainingCategories/Add.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
/***/ "./resources/js/src/store/actions/backend/training-categories.js":
/*!***********************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/training-categories.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['training-categories', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TRAINING_CATEGORIES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TRAINING_CATEGORIES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TRAINING_CATEGORIES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  reset: function reset() {
    return {
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TRAINING_CATEGORIES_RESET
    };
  },
